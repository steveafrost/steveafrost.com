...
I bought a [TRMNL](https://usetrmnl.com) — a small e-ink display that sits on your desk and cycles through widgets. Weather, calendar, stocks, that sort of thing. It also lets you build custom "recipes" using Liquid templates and API data. I live near a bus stop on TheRide system in Ann Arbor, and I wanted to glance at a screen and know when the next bus is coming without pulling out my phone.
...
The bus schedule sits on my desk next to my monitor. I glance at it, see "Route 27 -> Meijer at 3:42 pm," and know whether I need to leave now or have time to finish what I'm working on. No phone, no app, no notifications.
