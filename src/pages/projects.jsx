...
class Projects extends Component {
  render() {
    // const images = get(this, 'props.data.blogImages.edges');
    // images.forEach((img) => {
    //   console.log(img.node.id);
    // });
    ...
    return (
      <ProjectList>
        ...
        <Project>
          <h2>
            Daily Documentary - Browse, watch, and track today's hottest documentaries around the
            web
          </h2>
          <ul>
            <li>
        ...
        <Project>
          <h2>
            Plant Nanny - The personal plant assistant that curates gardener's tips and tricks
          </h2>
          <ul>
        ...
        <Project>
          ...
          <p>
            Web application built in Sinatra w/ Ruby that allows users to submit free activities to
            do around NYC. Users can modify their own activities and can view activities submitted
            by other users. Planned extendability for a ranking system.
          </p>
        </Project>
        <Project>
